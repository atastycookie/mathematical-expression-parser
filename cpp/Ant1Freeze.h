...
private:
	...
	enum {
		...
		CALC_SIN, CALC_COS, CALC_TG, CALC_CTG, CALC_ARCSIN, CALC_ARCCOS, ALC_ARCTG, 		CALC_ARCCTG, CALC_SH, CALC_CH, CALC_TH, CALC_CTH, CALC_EXP, CALC_LG, 			CALC_LN, CALC_SQRT, CALC_X, CALC_L_BRACKET, CALC_R_BRACKET, CALC_E, 			CALC_PI, CALC_NUMBER, CALC_END, CALC_G, ALC_EXP1,CALC_LEET
